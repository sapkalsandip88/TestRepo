...
<header>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" ><a href="/orderHistory">Booking History</a></li>
						<li class="breadcrumb-item active" aria-current="page">Booking Cancel</li>
				...
				<c:choose>
					<c:when test="${not empty result}">
						<h5 class="head_fh_attr2info text-center text-capitalize pb-5">
							Booking Cancelled</h5>
						<center>
							<h4>Your order id:${bookingno} has been successfully cancelled...</h4>
							<h4>In case you paid, refund will be processed within 7-8 working days.</h4>
						</center>
						<br>
						<br>
					</c:when>
