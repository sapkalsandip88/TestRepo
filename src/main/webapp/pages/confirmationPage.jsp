            ...
            <div class="privacy about">
                ...
                <center><h4>Your booking is confirmed. Thank You! </h4></center>
                    ...
                    <div>
						...
						<ul>
						<li>Booking Reference No:<i>-</i><span>${bookingno}</span></li>
						<li>Total:<i>-</i><span>${totalamount}</span></li>
						<li>Payment Mode:<i>-</i><span> ${paymode}</span></li>
						<li>Status:<i>-</i><span>${status}</span></li>
						</ul>
					</div> 
					<center>
        </c:when>
