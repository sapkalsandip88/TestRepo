					...
					<div class="row">
						...
						<div class="col-md-6">
							<p class="text-center mt-3">
								Create New Account? <a href=/registration
									class="text-dark login_btn"> <u>Register</u></a>
							...
							<form action="/login" method="post">
								<c:choose>
									<c:when test="${not empty message}">
										...
										<p class="text-center mt-3" style="color: red">${message}
										</p>
									</c:when>
								...
								<div class="form-group">
									<label for="recipient-name" class="col-form-label">Email id / Username
