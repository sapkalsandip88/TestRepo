...
<header>
	...
	<!-- <div class="ibanner_fh_attr1 pt-sm-5 pt-3">
		<h4
			class="head_fh_attr2info text-center text-capitalize text-center pt-5">
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/allPackages">All Packages</a></li>
	...
	<!-- Single -->
	<c:choose>
		<c:when test="${not empty packageinfoDetails}">
					...
					<div class="row my-sm-5">
                        ...
                        <div class="flexslider1">
                                    <div class="thumb-image">
                                        <img src="images/${packageinfoDetails.image}" data-imagezoom="true" alt=" " class="img-fluid"> </div>
						...
						<div
							...
							<h3>${packageinfoDetails.packagename}</h3>
							<p>
								${packageinfoDetails.altpname} </br>Test Included:
								${packageinfoDetails.nooftest}
							</p>
							<div class="caption">
								...
								<div class="clearfix"></div>
								<h6>&#8377; ${packageinfoDetails.price}</h6>
								<p>${packageinfoDetails.discount}
									% OFF </p> 
									<p class="line-through">&#8377; ${packageinfoDetails.actprice}
								</p>
							</div>
							<div class="desc_single">
								<h5>Description</h5>
								<p>${packageinfoDetails.dscr}</p>
							</div>
							<div class="d-sm-flex justify-content-between">
								<div class="occasional">
									<h5 class="sp_title mb-3">Recommended For</h5>
									<ul class="single_specific">
										<li><span>Gender: </span> <c:if
												test="${packageinfoDetails.male == 'YES'}">Male,</c:if> <c:if
												test="${packageinfoDetails.female == 'YES'}">Female</c:if></li>
										<li><span>Age :</span> ${packageinfoDetails.age} Years</li>
										<li><span>Prerequisite :</span>
											${packageinfoDetails.prerequisite}</li>
									</ul>
								...
								<div class="color-quality mt-sm-0 mt-4">
									...
									<ul class="single_serv">
										<li><a href="#">Free home sample collection for booking above &#8377; 600</a></li>
										<li class="mt-2"><a href="#">Reports with in 48
												Hrs.(Digital Reporting)</a></li>
										<li class="mt-2"><a href="#">Cash on Sample
												Collection available</a></li>
									</ul>
								</div>
							</div>
							<div class="description">
								<h5>Check services, payment options and charges at your
									location</h5>
								<form action="#" method="post">
							...
							<div class="occasion-cart">
								<div class="chr single-item single_page_b">
									<form action="#" method="post">
										...
										<input type="hidden" name="hub_item" value="${packageinfoDetails.packagename}"> 
										<input type="hidden" name="amount" value="${packageinfoDetails.price}">
		...
		<c:otherwise>
			<center>
				<h2 style="color: red; margin-top: -150px;">No Course Found.</h2>
			</center>
		</c:otherwise>
	</c:choose>
	<!-- /new_arrivals -->
	<div class="section singlep_btm pb-5">
		<div class="container">
			<div class="new_arrivals">
				<h4 class="rad-txt text-capitalize">Recommended Packages
					</h4>
				<!-- card group 2 -->
						...
						<div class="col-lg-3 col-sm-6 p-0">
							<div class="card product-men p-3">
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="/quickViewP/${packageList.packagename}" class="link-product-add-cart">Quick
												View</a>
										</div>
									</div>
								</div>
								...
								<div class="card-body  py-3 px-2">
									<h5 class="card-title text-capitalize"><b>${packageList.packagename}</b></br>
                                    ${packageList.altpname}</h5>
								...
								<form action="/quickViewP" method="post">
									...
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> 
										<input type="hidden" name="add" value="1"> 
										<input type="hidden" name="hub_item" value="${packageList.packagename}">
                                        <input type="hidden" name="amount" value="${packageList.price}">
										<button type="submit" class="hub-cart phub-cart btn">
											<i class="fa fa-cart-plus" aria-hidden="true"></i>
										</button>
										<a href="#" data-toggle="modal" data-target="#myModal1"></a>
