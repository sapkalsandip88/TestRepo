...
<body>
 ...
 <header>
    ...
    <!-- //breadcrumbs -->
    <!--Payment-->
    <section class="payment_fh_attr1ls py-5">
        <div class="container">
            <div class="privacy about">
               <h5 class="head_fh_attr2info text-center text-capitalize pb-5">
				...
				<center><h4>We are pleased to inform that your booking request received and confirmed.</h4></center>
                <br>
                <center><h4>Your booking is confirmed. Thank You! </h4></center>
    ...
    <div class="container register">
        <div class="row">
            <div class="col-md-3 register-left">
                ...
                <h3>Welcome</h3>
                <p>You are 30 seconds away from placing your booking..!</p>
            </div>
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="first-row form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <input class="billing-address-name form-control" type="text" name="ORDER_ID" value="${bookingno}" readonly>
                                                    </div>
                                                    <div class="controls">
                                                        <label class="control-label">Payment Mode</label>
                                                        <input class="billing-address-name form-control" type="text" name="paymode" value="${paymode}" readonly>
                                                    </div>
                                                    <div class="controls">
                                                        <label class="control-label">Booking Status</label>
                                                        <input class="billing-address-name form-control" type="text" name="paymode" value="${status}" readonly>
                                                    </div>
                                                    <div class="controls" hidden>
                                                        <label class="control-label">Customer ID</label>
                                                        <input class="billing-address-name form-control" type="text" name="CUST_ID" value="${custid}" readonly>
                                                    </div>
                                                    <div class="controls" hidden>
                                                        <label class="control-label">INDUSTRY_TYPE_ID</label>
                                                        <input class="billing-address-name form-control" type="text" name="INDUSTRY_TYPE_ID" value="Retail" readonly>
                                                    </div>
                                                    <div class="controls" hidden>
                                                        <label class="control-label">CHANNEL_ID</label>
                                                        <input class="billing-address-name form-control" type="text" name="CHANNEL_ID" value="WEB" readonly>
                                                    </div>
                                                    <div class="controls">
                                                        <label class="control-label">Amount</label>
                                                        <input class="billing-address-name form-control" type="text" name="TXN_AMOUNT" value="${totalamount}" readonly>
                                                    </div>
                                                  <br>
