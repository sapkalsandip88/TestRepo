			...
			<div class="privacy about">
				...
				<c:choose>
					...
					Booking Confirmed</h5>
						<center>
							<h4>We are pleased to inform that your payment request
								received and confirmed.</h4>
						</center>
						<br>
						<center>
							<h4>${result}. Thank You!</h4>
						</center>
						<br>
						...
						<center>
							<div>
								...
								<ul>
										<li>Order Id<i>-</i><span>${ORDERID}</span></li>
										<li>Transaction Id<i>-</i><span>${TXNID}</span></li>
										<li>Amount Rs<i>-</i><span>${TXNAMOUNT}</span></li>
								</ul>
							</div>
							</center>
					</c:when>
