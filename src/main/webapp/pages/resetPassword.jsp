			...
			<div class="modal-content">
				...
				<div class="modal-body  pt-3 pb-5 px-sm-5">
					<div class="row">
						...
						<div class="col-md-6">
            			<form action="/reset-password"  th:object="${user}" method="post">
							
								<div class="form-group">
									<label for="recipient-name" class="col-form-label">Email id
										</label> <input th:field="*{email}" type="text" class="form-control" placeholder=" "
										name="email" id="email" required="">
								</div>
								<div class="form-group">
									<label class="col-form-label">Password</label> <input th:field="*{password}"
