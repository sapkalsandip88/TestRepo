...
<header>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/allTest">All Test </a></li>
			<li class="breadcrumb-item active" aria-current="page">Test Info</li>
		</ol>
	</nav>
	<!-- //breadcrumbs -->
	<!-- Single -->
	<c:choose>
		<c:when test="${not empty testinfoDetails}">
			<div class="innerf-pages section py-5">
				<div class="container">
					<div class="row my-sm-5">
						<div class="col-lg-4 single-right-left"></div>
						<div
							class="col-lg-8 mt-lg-0 mt-5 single-right-left simpleCart_shelfItem">
							<h3>${testinfoDetails.testname}</h3>
							<p>
								${testinfoDetails.altname} </br>Parameters Included:
								${testinfoDetails.nop}
							</p>
							<div class="caption">
								...
								<h6>&#8377; ${testinfoDetails.price}</h6>
								<p>${testinfoDetails.discount}% OFF</p>
								<p class="line-through">&#8377; ${testinfoDetails.actprice}
								</p>
							</div>
							<div class="desc_single">
								<h5>Description</h5>
								<p>${testinfoDetails.dscr}</p>
							</div>
							<div class="d-sm-flex justify-content-between">
								<div class="occasional">
									...
									<ul class="single_specific">
										<li><span>Gender: </span> <c:if
												test="${testinfoDetails.male == 'YES'}">
												<i class="fa fa-male" aria-hidden="true"></i> Male,</c:if> <c:if
												test="${testinfoDetails.female == 'YES'}">
												<i class="fa fa-female" aria-hidden="true"></i> Female</c:if></li>
										<li><span>Age :</span> ${testinfoDetails.age} Years</li>
										<li><span>Prerequisite :</span>
											${testinfoDetails.prerequisite}</li>
									</ul>
								...
								<div class="color-quality mt-sm-0 mt-4">
									...
									<ul class="single_serv">
										<li><a href="#">Free home sample collection for
												booking above &#8377; 600 </a></li>
										<li class="mt-2"><a href="#">Reports with in 48
												Hrs.(Online Reporting)</a></li>
								...
								<div class="chr single-item single_page_b">
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											...
											value="${testinfoDetails.testname}"> <input
											type="hidden" name="amount" value="${testinfoDetails.price}">
