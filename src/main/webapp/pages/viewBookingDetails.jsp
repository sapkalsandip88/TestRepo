...
<header>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="/orderHistory">Order
				History</a></li>
	...
	<section class="checkout_fh_attr3 py-sm-5 py-3">
		<div class="container">
			<div class="check_fh_attr1ls">
				...
				<center><h4>Order Deatials</h4></center>
					<c:choose>
							...
							<div class="item">
								...
								<div class="card product-men p-3">
									...
									<div class="card-body" style="background-color: #E9F7EF">
										<table>
											<tr>
												<td>Order No:</td><td><b>${bookingno}</b></td>
											</tr>
											<tr>
												<td>Date: </td><td><b>${bookingdate}</b></td>
											</tr>
											<tr>
											...
											<tr>
												<td>Address Type:</td><td> <b>${addtype}</b></td>
											</tr>
											...
											<tr>
												<td>Payment Mode:</td><td> <b>${paymode}</b></td>
											</tr>

											<tr>
												<td width="25%">Booking Status: </td><td><b>
														${bookingstatus}</b></td>
											</tr>
											<tr>
												<td width="25%">Sample Collected: </td><td><b>${samplecollected}</b></td>
											</tr>
											<tr>
												<td width="25%">Sample Collection Date:</td><td><b>${samplecollecteddate}</b></td>
											</tr>
											<tr>
												<td width="25%">Report Delivered: </td><td><b>${reportdelivered}</b></td>
											</tr>
											<tr>
												<td width="25%">Report Delivery Date:</td><td><b>${reportdelivereddate}</b></td>
											</tr>
										</table>
										<br>
										<b>Test Details</b>
										...
										<table>
											...
											<c:forEach var="testDetails" items="${testDetails}">
												<tr>
													<td width="25%"></td>
													<td width="50%"><b>${testDetails.testanme}</b></td>
													<td width="25%"><b>${testDetails.price}</b></td>
												</tr>
											</c:forEach>
										</table>
										...
										<b>Download Report</b>
										<br>
										<b>Download Invoice  <a href="/downloadInvoice/${bookingno}"><img src="/images/pdf.png" width="30" hight="30"/></a></b>
									</div>
									<!-- card footer -->
								</div>
								<!-- //card -->
